...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MusicianGear'
        db.create_table('musiciangear_musiciangear', (
        ...
        db.send_create_signal('musiciangear', ['MusicianGear'])


    def backwards(self, orm):
        
        # Deleting model 'MusicianGear'
        db.delete_table('musiciangear_musiciangear')
