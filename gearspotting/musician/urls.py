...
urlpatterns = patterns(
    ...
    (r'^(?P<slug>[^/]+)/edit_links/?$', 'gearspotting.musician.views.edit_links'),
    ...
    (r'^(?P<slug>[^/]+)/edit_photos/?$', 'gearspotting.musician.views.edit_photos'),
    (r'^(?P<slug>[^/]+)/edit_gear/?$', 'gearspotting.musician.views.edit_gear'),
    (r'^(?P<slug>[^/]+)/$',
