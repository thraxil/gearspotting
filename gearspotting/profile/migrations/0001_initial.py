...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profile_myprofile', (
        ...
        db.send_create_signal('profile', ['MyProfile'])


    def backwards(self, orm):
        
        # Deleting model 'MyProfile'
        db.delete_table('profile_myprofile')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 3, 20, 30, 7, 241445)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 3, 20, 30, 7, 241350)'}),
